...
* `START_MESSAGE` Optional: start message of bot, use HTML and <a href='https://github.com/ilhamganteng1/File-Sharing-Bot/blob/6-subsREADME.md#start_message'>fillings</a>
