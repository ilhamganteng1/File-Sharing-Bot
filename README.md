...
* `CUSTOM_CAPTION` put your Custom caption text if you want Setup Custom Caption, you can use HTML and <a hhref='https://github.com/JishuDeveloper/File-Sharing-Bot/blob/6-subs/README.md#start_message'>fillings</a> for formatting (only for documents)
